...
public final class AttributeSynthetic extends Attribute {
    public static final Mutf8Slice NAME = new Mutf8Slice("Synthetic");
    ...
    public AttributeSynthetic(int attribute_name_index) {
    ...
    public void accept(RecombobulatorVisitor v) {
        v.visitAttributeSynthetic(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AttributeSynthetic) {
            AttributeSynthetic o = (AttributeSynthetic) obj;
            if (
