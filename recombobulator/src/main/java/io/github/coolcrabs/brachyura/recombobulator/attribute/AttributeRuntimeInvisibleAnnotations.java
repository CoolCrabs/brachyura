...
public final class AttributeRuntimeInvisibleAnnotations extends Attribute {
    public static final Mutf8Slice NAME = new Mutf8Slice("RuntimeInvisibleAnnotations");
    ...
    public AttributeRuntimeInvisibleAnnotations(int attribute_name_index, List<Annotation> annotations) {
    ...
    public void accept(RecombobulatorVisitor v) {
        v.visitAttributeRuntimeInvisibleAnnotations(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AttributeRuntimeInvisibleAnnotations) {
            AttributeRuntimeInvisibleAnnotations o = (AttributeRuntimeInvisibleAnnotations) obj;
            if (
