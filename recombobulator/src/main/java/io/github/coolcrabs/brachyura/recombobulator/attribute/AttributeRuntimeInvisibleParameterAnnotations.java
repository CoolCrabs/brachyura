...
public final class AttributeRuntimeInvisibleParameterAnnotations extends Attribute {
    public static final Mutf8Slice NAME = new Mutf8Slice("RuntimeInvisibleParameterAnnotations");
    ...
    public AttributeRuntimeInvisibleParameterAnnotations(int attribute_name_index, List<EntryParameterAnnotations> parameter_annotations) {
    ...
    public void accept(RecombobulatorVisitor v) {
        v.visitAttributeRuntimeInvisibleParameterAnnotations(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AttributeRuntimeInvisibleParameterAnnotations) {
            AttributeRuntimeInvisibleParameterAnnotations o = (AttributeRuntimeInvisibleParameterAnnotations) obj;
            if (
