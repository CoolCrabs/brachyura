...
public final class AttributeNestMembers extends Attribute {
    public static final Mutf8Slice NAME = new Mutf8Slice("NestMembers");
    ...
    public AttributeNestMembers(int attribute_name_index, U2Slice classes) {
    ...
    public void accept(RecombobulatorVisitor v) {
        v.visitAttributeNestMembers(this);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AttributeNestMembers) {
            AttributeNestMembers o = (AttributeNestMembers) obj;
            if (
