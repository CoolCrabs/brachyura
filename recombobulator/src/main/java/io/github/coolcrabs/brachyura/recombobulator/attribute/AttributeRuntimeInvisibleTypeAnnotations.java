...
public final class AttributeRuntimeInvisibleTypeAnnotations extends Attribute {
    public static final Mutf8Slice NAME = new Mutf8Slice("RuntimeInvisibleTypeAnnotations");
    ...
    public static final AttributeType TYPE = new AttributeType(52, 0, EnumSet.of(AttributeType.Location.CLASS_FILE, AttributeType.Location.FIELD_INFO, AttributeType.Location.METHOD_INFO, AttributeType.Location.CODE, AttributeType.Location.RECORD_COMPONENT)) {
        ...
        Attribute read(ByteBuffer b, int pos, int attribute_name_index, int attribute_length, RecombobulatorOptions options, ConstantPool pool, int major, int minor) {
            ...
            return new AttributeRuntimeInvisibleTypeAnnotations(
    ...
    public AttributeRuntimeInvisibleTypeAnnotations(int attribute_name_index, List<TypeAnnotation> annotations) {
    ...
    public void accept(RecombobulatorVisitor v) {
        v.visitAttributeRuntimeInvisibleTypeAnnotations(this);
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof AttributeRuntimeInvisibleTypeAnnotations) {
            AttributeRuntimeInvisibleTypeAnnotations o = (AttributeRuntimeInvisibleTypeAnnotations) obj;
            if (
